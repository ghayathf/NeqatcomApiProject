...
namespace Neqatcom.Infra.Repository
{
    public class HomeRepository : IHomeRepository
    {
        ...
        {
            var p = new DynamicParameters();
            p.Add("Id_", id, dbType: DbType.String, ParameterDirection.Input);
        ...
        {
            IEnumerable<Gphomepage> result = _dbContext.Connection.Query<Gphomepage>("Final_HomePage_Package.GetAllHomeInfo", commandType: CommandType.StoredProcedure);
        ...
        {
            var p = new DynamicParameters();
            p.Add("HOME_ID", finalHomepage.Id, dbType: DbType.Int32, ParameterDirection.Input);
